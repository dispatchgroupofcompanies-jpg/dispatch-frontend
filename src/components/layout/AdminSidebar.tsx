...
export default function AdminSidebar({
  ...
  return (
    <div
      style={{
        width: isMobile ? "min(260px, 100vw)" : collapsed ? 80 : 260,
        background: "linear-gradient(180deg, #14233f 0%, #1b3155 100%)",
        color: "white",
        height: "100svh",
    ...
    >
      ...
      >
        ...
        {(!collapsed || isMobile) && (
          <Tooltip
            title={collapsed && !isMobile ? (showAllMenu ? "Show Less" : "Show More") : ""}
            placement="right"
            overlayStyle={{ marginLeft: 8 }}
          >
            <div
