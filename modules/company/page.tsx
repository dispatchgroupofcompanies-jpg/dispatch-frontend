    ...
    <div style={{ padding: "24px", maxWidth: "1000px", margin: "0 auto" }}>
      ...
      >
        <div>
          ...
          <p style={{ margin: 0, color: "#64748b" }}>
            Manage and view your system backend profiles setup
          </p>
        </div>
      ...
      {loading ? (
        ...
        <Card
          title={
            <Space>
              <GlobalOutlined style={{ color: "#1e3a8a" }} />{" "}
              <span style={{ fontWeight: 600 }}>{profileData.companyName}</span>
            </Space>
          }
          extra={
            <Space size="middle">
        ...
        >
          ...
          >
            <Descriptions.Item label="Carrier ID">
              {profileData.carrierIdentifier}
            </Descriptions.Item>
            ...
            <Descriptions.Item label="NSC Number">
              {profileData.nsc}
            </Descriptions.Item>
            <Descriptions.Item label="GST/HST">
              {profileData.gstHst}
            </Descriptions.Item>
            <Descriptions.Item label="City & Country">
              {profileData.city},{" "}
              {profileData.country === "CA" ? "Canada" : "USA"}
            </Descriptions.Item>
            <Descriptions.Item label="Postal Code">
              {profileData.postCode}
            </Descriptions.Item>
            <Descriptions.Item label="E-Transfer Address">
              {profileData.eTransfer}
            </Descriptions.Item>
          </Descriptions>
        </Card>
      ) : (
        ...
        >
          No system configuration profile detected. Please initiate a setup
      ...
      <Modal
        title={
          <span style={{ fontWeight: 700, fontSize: 16 }}>
            📋 Full Company Profile Summary View
          </span>
        }
      ...
      >
        {profileData && (
          <div style={{ marginTop: 16, maxHeight: "65vh", overflowY: "auto" }}>
            ...
            <p>
              <strong>Carrier Identifier:</strong>{" "}
              {profileData.carrierIdentifier}
            </p>
            <p>
              <strong>NSC Number:</strong> {profileData.nsc}
            </p>
            <p>
              <strong>IFTA:</strong> {profileData.ifta}
            </p>
            ...
            <p>
              <strong>GST/HST Number:</strong> {profileData.gstHst}
            </p>
            <p>
              <strong>QST Number:</strong> {profileData.qst || "N/A"}
            </p>
            <p>
              <strong>E-Transfer Email:</strong> {profileData.eTransfer}
            </p>
            ...
            <p>
              <strong>Phone:</strong> {profileData.countryCode}{" "}
              {profileData.phone}
            </p>
            <p>
              <strong>Address:</strong> {profileData.addressLine1}{" "}
              {profileData.addressLine2 ? `, ${profileData.addressLine2}` : ""}
            </p>
            <p>
              <strong>City, State & Postal:</strong> {profileData.city},{" "}
              {profileData.state} - {profileData.postCode}
            </p>
            <p>
              <strong>Country:</strong>{" "}
              {profileData.country === "CA" ? "Canada" : "United States"}
            </p>
          </div>
        )}
      </Modal>
