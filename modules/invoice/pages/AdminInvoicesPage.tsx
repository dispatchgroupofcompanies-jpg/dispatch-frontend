...
export default function AdminInvoicesPage() {
  ...
  return (
    <div className={design.page}>
      <AdminPageHeader title="Invoice approval" description="Review invoices, manage approvals and track payment status." section="APPROVALS" />

      {/* Content Container */}
      <div className={design.content}>
        {/* Controls Card (Search Bar + Dropdowns) */}
        <Card
          className={design.filters}
          size="small"
          style={{
            marginBottom: 12,
